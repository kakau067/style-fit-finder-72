...
function Index() {
  ...
  // Keep merchant/database metadata, but demo products must use the asset URLs
  // generated by this build. Legacy database paths can otherwise point to files
  // that no longer exist and break the public try-on flow.
